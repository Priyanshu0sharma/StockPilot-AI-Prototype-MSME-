...
export async function ensureAutoSeeded() {
  try {
    ...
    autoSeedPromise = (async () => {
      console.log("🌱 Auto-seeding default MSME prototype dataset...");

      // 1. Clear any stale records if any
      ...
      console.log("✅ Auto-seeded dataset successfully.");
    })();
